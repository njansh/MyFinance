...
public class SecurityConfig {
    ...
    // 2. Define as regras de CORS permitindo o seu Frontend Next.js
    @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowCredentials(true); // Necessário para quando você implementar Cookies HttpOnly no futuro
