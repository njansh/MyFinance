...
public class ProcessTransactionInGoalUseCase implements ProcessTransactionInGoalPort {

    private final GoalRepositoryPort goalRepositoryPort;

    public ProcessTransactionInGoalUseCase(GoalRepositoryPort goalRepositoryPort) {
