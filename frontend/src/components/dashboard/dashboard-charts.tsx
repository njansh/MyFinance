        ...
        <div className="flex-1 w-full h-full min-h-0">
          {formattedExpenses.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={formattedExpenses} cx="50%" cy="50%" innerRadius={70} outerRadius={95} paddingAngle={4} dataKey="value" isAnimationActive={true} animationDuration={600} animationEasing="ease-out">
      ...
      <div className="p-6 bg-white border border-slate-200/80 rounded-2xl shadow-sm flex flex-col h-[400px] hover:shadow-md transition-shadow duration-200">
        ...
        <div className="flex-1 w-full h-full min-h-0">
          {formattedIncomes.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={formattedIncomes} cx="50%" cy="50%" innerRadius={70} outerRadius={95} paddingAngle={4} dataKey="value" isAnimationActive={true} animationDuration={600} animationEasing="ease-out">
