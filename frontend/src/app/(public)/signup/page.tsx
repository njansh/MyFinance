...
import { signupAction } from '../../(private)/actions/auth'
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4 antialiased text-slate-900">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-2xl border border-slate-200/80 shadow-xl">
        <div className="space-y-2 text-center">
          ...
          <p className="text-sm font-medium text-slate-400">Crie sua conta e controle seu dinheiro em minutos</p>
        </div>
        ...
        <p className="text-xs font-semibold text-center text-slate-400">
          Já tem uma conta?{' '}
          <Link href="/login" className="text-emerald-600 hover:text-emerald-700 hover:underline transition">
            Faça login aqui
          </Link>
        </p>
      </div>
